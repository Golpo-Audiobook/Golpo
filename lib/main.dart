...
import 'package:golpo/services/audio_service.dart';
import 'package:golpo/services/data_manager.dart';
import 'package:golpo/services/logger_service.dart';
import 'package:golpo/services/router_service.dart';
import 'package:golpo/services/settings_manager.dart';
import 'package:golpo/style/app_themes.dart';
import 'package:golpo/widgets/mini_player.dart';
                      ...
                      return NavigationBar(
                        ...
                        destinations: [
                          ...
                          NavigationDestination(
                            ...
                            selectedIcon:
                                const Icon(FluentIcons.library_24_filled),
                            label: context.l10n?.playlists ?? 'Library',
                          ),
                          NavigationDestination(
                            icon: const Icon(FluentIcons.heart_24_regular),
                            selectedIcon:
                                const Icon(FluentIcons.heart_24_filled),
                            label: context.l10n?.recentlyPlayed ?? 'Favorites',
                          ),
                          NavigationDestination(
                            icon: const Icon(
  ...
  try {
    ...
    audioHandler = await AudioService.init(
      ...
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'com.golpo.audiobook',
